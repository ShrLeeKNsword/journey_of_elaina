 ...
 * 设置色调旋转值。
 *
 * @param {number} hue 色相值（-360，360）。- The hue value (-360, 360).
 */
 ...
 * Sets the color tone.
 *
 * @param {array} tone 色调[r，g，b，灰色]。- The color tone [r, g, b, gray].
 */
 ...
 * 设置混合颜色。
 *
 * @param {array} color 混合色[r，g，b，a]。- The blend color [r, g, b, a].
 */
 ...
 * 设置亮度。
 *
 * @param {number} brightness 亮度（0至255）。- The brightness (0 to 255).
 */
